...
def main():
    ...
    while now<end and running == True:
        ...
        if play and now > start_time + 15: #calibration or initial stabilisation
            visual_gain = 5
        if play and now > start_time + 30: # disturbance sep 
            visual_gain = 10
        if play and now > start_time + 40: # disturbance sep 
            visual_gain = 15
        if play and now > start_time + 47: # disturbance sep 
            visual_gain = 20
        if play and now > start_time + 52: # disturbance sep 
            visual_gain = 30
    ...
    # np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials' + '/time', np.array(time))

    
         
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/85sec_trial' + '/time', np.array(time))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/85sec_trial' + '/position', np.array(position))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/85sec_trial' + '/angle', np.array(angle))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/85sec_trial' + '/raw_position', np.array(raw_hand_position))
    print(visual_gain)
