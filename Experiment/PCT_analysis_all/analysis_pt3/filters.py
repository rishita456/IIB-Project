...
y_k = kalman(steps, 1)
print(np.shape(y_k[500:4500]))

fig, axs = plt.subplots(2)
axs[0].plot(time[500:4500],steps[500:4500], label = 'raw step data', alpha = 0.5)
axs[0].plot(time[500:4500],y[500:4500], label = 'Butterworth filter')
axs[1].plot(time[500:4500],steps[500:4500], label = 'raw step data', alpha = 0.5)
axs[1].plot(time[500:4500],y_k[500:4500], label = 'Kalman filter')
...
fig, axs = plt.subplots(2)
axs[0].plot(freq, np.abs(fft_result), label = 'fft of step position data', alpha = 0.5)
axs[0].plot(freq, np.abs(fft_result2), label = 'fft of butterworth filtered step position data', alpha = 0.5)
axs[1].plot(freq, np.abs(fft_result), label = 'fft of step position data', alpha = 0.5)
axs[1].plot(freq, np.abs(fft_result3), label = 'fft of kalman filtered step position data', alpha = 0.5)
axs[0].legend()
axs[1].legend()
