...
def main():
    ...
    while now<end and running == True:
        ...
        if play and now > start_time + 47: # disturbance sep 
            visual_gain = 20
        if play and now > start_time + 49: # disturbance sep 
            visual_gain = 30
    ...
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/83sec_trial' + '/time', np.array(time))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/83sec_trial' + '/position', np.array(position))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/83sec_trial' + '/angle', np.array(angle))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/test_trials/83sec_trial' + '/raw_position', np.array(raw_hand_position))
    print(visual_gain)
