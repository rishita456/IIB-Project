...
def main():
    ...
    trial_gains = np.repeat(trial_gains[0],2)
    ...
    while now<end and running == True:
        ...
        if play and now > start_time: #pilot part 1 - 30 sec trials at different gains
            visual_gain = trial_gains[(trial_index)] # enter id
    ...
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/0_disturbance/g0_' + str(visual_gain) + '/trial' + str(trial_index%2 + 1) + '/time', np.array(time))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/0_disturbance/g0_' + str(visual_gain) + '/trial' + str(trial_index%2 + 1) + '/position', np.array(position))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/0_disturbance/g0_' + str(visual_gain) + '/trial' + str(trial_index%2 + 1) + '/angle', np.array(angle))
    np.save('/Users/rishitabanerjee/Desktop/ProjectStuff/BrainMachineInterfaces/Experiment/participant_' + str(participant_id) + '/0_disturbance/g0_' + str(visual_gain) + '/trial' + str(trial_index%2 + 1) + '/raw_position', np.array(raw_hand_position))
